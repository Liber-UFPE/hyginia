...
import br.ufpe.liber.search.BooksSearch
...
class SearchController(private val booksSearch: BooksSearch, private val templates: Templates) : KteController {
    @Get("/search")
    ...
    private fun runSearch(query: String, page: Optional<Int>): HttpResponse<KteWriteable> {
        ...
        val searchResults = try {
            booksSearch.search(query, currentPage)
